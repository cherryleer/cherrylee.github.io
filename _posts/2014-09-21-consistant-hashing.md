...
Hashing）及其在分布式系统中的应用。首先本文会描述一个在日常开发中经常会遇到的问题场景，借此介绍一致性哈希算法以及这个算法如何解决此问题；接下来会对这个算法进行相对详细的描述，并讨论一些如虚拟节点等与此算法应用相关的话题。

##分布式缓存问题##

假设我们有一个网站，最近发现随着流量增加，服务器压力越来越大，之前直接读写数据库的方式不太给力了，于是我们想引入Memcached作为缓存机制。现在我们一共有三台机器可以作为Memcached服务器，如下图所示。

<p class="picture"><img alt="" src="/assets/img/2014-09-21/1.png"/></p>
...
<p class="picture"><img alt="" src="/assets/img/2014-09-21/5.png"/></p>
...
<p class="picture"><img alt="" src="/assets/img/2014-09-21/6.png"/></p>
...
<p class="picture"><img alt="" src="/assets/img/2014-09-21/7.png"/></p>
...
<p class="picture"><img alt="" src="/assets/img/2014-09-21/8.png"/></p>
